...
class Ui_MainWindow(object):
    ...
    def chay_trinh_duyet(self, info):
        ...
        driver.refresh()
        time.sleep(2)
        driver.find_element(By.LINK_TEXT, "Change Email Address").click()
        time.sleep(3)
        driver.find_element(By.NAME, "new").send_keys("respectabledorette@jcnorris.com")
        time.sleep(500)
        # Kiểm tra đã đăng nhập thành công chưa
        a = "/html/body/div/div/div[2]/div/div[2]/div/div[2]/a"
        driver.find_element(By.LINK_TEXT, "Change Email Address")
        # Đóng trình duyệt
        driver.quit()
