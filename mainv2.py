...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(150, 10, 400, 51))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "TOOL TỰ LẤY TOKEN APP CM V2 API"))
        ...
        self.input_listck.setPlainText("https://clone24h.com/api/BResource.php?username=khanhuypr&password=khanhuy1&id=191&amount=2")
        self.groupBox_2.setTitle(_translate("MainWindow", "Auto"))
        self.label_5.setText(_translate("MainWindow", "Thứ tự cookie"))
        self.label_6.setText(_translate("MainWindow", "Link get"))
    ...
    def loop_chay_trinh_duyet(self):
        #fix lai v2
        link_api = str(self.input_listck.toPlainText()).strip()
        ...
        if response.status_code == 200:
            ...
            if data.get('status') == 'success':
                ...
                arr_info = [item['account'] for item in data['data']['lists']]
                print(f"Số lương: {len(arr_info)}")
            else:
                print("Có lỗi xảy ra:", data.get('msg'))
        else:
